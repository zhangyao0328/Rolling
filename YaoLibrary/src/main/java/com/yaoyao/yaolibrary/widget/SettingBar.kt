...
/**
 * @author zhangyao
 * @date 11/29/20  1:07 PM
 * @E-mail android_n@163.com
 */
open class SettingBar(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) : FrameLayout(context, attrs, defStyleAttr, defStyleRes) {
    /**
     * 获取主布局
     */
    ...
    init {
        ...
        // 文字大小设置
        setLeftSize(TypedValue.COMPLEX_UNIT_SP, array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftSize, 15).toFloat())
        setRightSize(TypedValue.COMPLEX_UNIT_SP, array.getDimensionPixelSize(R.styleable.SettingBar_bar_rightSize, 14).toFloat())
        ...
        if (background == null) {
            ...
            drawable.addState(intArrayOf(android.R.attr.state_pressed), ColorDrawable(ContextCompat.getColor(getContext(), R.color.black5)))
            drawable.addState(intArrayOf(android.R.attr.state_selected), ColorDrawable(ContextCompat.getColor(getContext(), R.color.black5)))
            drawable.addState(intArrayOf(android.R.attr.state_focused), ColorDrawable(ContextCompat.getColor(getContext(), R.color.black5)))
            drawable.addState(intArrayOf(), ColorDrawable(ContextCompat.getColor(getContext(), R.color.white)))
            background = drawable
