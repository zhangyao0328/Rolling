...
public final class ScreenUtils {
    ...
    /**
     * Set the screen toolbar_main landscape.
     *
     * @param activity The activity.
     */
    ...
    /**
     * Set the screen toolbar_main portrait.
     *
     * @param activity The activity.
     */
     ...
     *
     * @param activity          The activity.
     * @param isDeleteStatusBar True toolbar_main delete status bar, false otherwise.
     * @return the bitmap of screen
     */
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) MyApplication.getInstance().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static boolean isTablet() {
        return (MyApplication.getInstance().getResources().getConfiguration().screenLayout
